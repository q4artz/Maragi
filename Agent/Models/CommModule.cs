...
namespace Agent.Models
{
    public abstract class CommModule
    {
        ...
        // can use virtual bool to override class/implementation in httpCommModule
        ...
        // having send and reveive on Abstract class so no need to redo everytime you have new listener
